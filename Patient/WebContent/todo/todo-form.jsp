...
<body>
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.facebook.com/satish" class="navbar-brand"> Patient
					App</a>
			</div>
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Feedback Decription</label> <input type="text"
						value="<c:out value='${todo.description}' />" class="form-control"
						name="description" minlength="5">
				</fieldset>

				<fieldset class="form-group">
					<label>Visit Status</label> <select class="form-control"
						name="isDone">
